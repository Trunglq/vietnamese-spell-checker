...
"""
Test Advanced Vietnamese Spell Checker
"""

from advanced_spell_checker import advanced_spell_checker
import time

def test_advanced_spell_checker():
    """Test phiên bản nâng cao"""
    
    print("🚀 Test Advanced Vietnamese Spell Checker")
    print("=" * 60)
    ...
    for i, text in enumerate(test_cases, 1):
        ...
        result = advanced_spell_checker.check_text(text)
        end_time = time.time()
