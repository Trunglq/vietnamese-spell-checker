...
"""
Test Smart Vietnamese Spell Checker
"""

from smart_spell_checker import smart_spell_checker
import time

def test_smart_spell_checker():
    """Test phiên bản thông minh"""
    
    print("🧠 Test Smart Vietnamese Spell Checker")
    print("=" * 60)
    ...
    for i, text in enumerate(test_cases, 1):
        ...
        result = smart_spell_checker.check_text(text)
        end_time = time.time()
